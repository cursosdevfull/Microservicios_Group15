...
(async () => {
    try {
        ...
        const kafka = KafkaService.getInstance([env.KAFKA_TOPIC_MX, env.KAFKA_TOPIC_CONFIRM, env.KAFKA_TOPIC_ERROR], env.KAFKA_GROUP_ID, KafkaBootstrap.getInstanceKafka())
